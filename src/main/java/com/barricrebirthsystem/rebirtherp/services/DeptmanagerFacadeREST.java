...
import com.barricrebirthsystem.rebirtherp.entities.Deptmanager;
...
public class DeptmanagerFacadeREST extends AbstractFacade<Deptmanager> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Deptmanager entity) {
        super.edit(entity);
    }
    ...
    public Deptmanager find(@PathParam("id") Integer id) {
